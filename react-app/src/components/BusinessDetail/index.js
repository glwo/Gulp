...
const BusinessDetail = () => {
  ...
  let businessReview;
  if (allReviews && currentBusiness) {
    businessReview = Object.values(allReviews).filter(review => review.business_id == currentBusiness.id)
              ...
              <div className="review-overall-rating-div">
                ...
                <div className="review-rating-div">
                  <div className="rating-bar">
                    ...
                    {/* <meter min="0" max={currentBusiness.num_reviews} value={filterReview(businessReview, 5)} >Score out of 10</meter> */}
                    <meter min="0" max={currentBusiness.num_reviews} value="9" >Score out of 10</meter>
                  </div>
                  <div className="rating-bar">
                    <div>
                      4 stars
                    </div>
                    {/* <meter min="0" max={currentBusiness.num_reviews} value={filterReview(businessReview, 4)} >Score out of 10</meter> */}
                    <meter min="0" max={currentBusiness.num_reviews} value="9" >Score out of 10</meter>
                  </div>
                  <div className="rating-bar">
                    <div>
